...
func Detect() Info {
	...
	case "amd64":
		...
		info.Level = EvaluateAMD64(feat)
		info.Features = extractX86FeatureList(feat)
	case "arm64":
		feat := currentARM64Features()
		info.Level = EvaluateARM64(feat)
		info.Features = extractARM64FeatureList(feat)
	default:
		info.Level = "v1"
	}
