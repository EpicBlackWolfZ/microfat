...
| Characteristic | Native ELF (`v3`) | Universal FAT (`v1`–`v4`) | Trimmed FAT (`--microfat:trim`) |
| :--- | :--- | :--- | :--- |
| **Disk Footprint** | `3.91 MB` (`4,100,359 B`) | `9.94 MB` (`10,425,594 B`) | `4.88 MB` (`5,117,644 B`, **-50.9%**) |
| **Startup Overhead** | `~1.8 ms` | `~8.6 ms` (+6.8ms decompression) | `~8.8 ms` (+7.0ms decompression) |
